...
export const InboxHeader = (props: InboxHeaderProps) => {
  ...
  return (
    <Animated.View style={tailwind.style('bg-blue-800')}>
      <Animated.View
        ...
        <Animated.View style={tailwind.style('flex-1')}>
          <Pressable hitSlop={16} onPress={markAllAsRead}>
            <Icon icon={<DoubleCheckIcon stroke="white" />} size={24} />
          </Pressable>
        </Animated.View>
        <Animated.View style={tailwind.style('flex-1')}>
          <Animated.Text
            style={tailwind.style(
              'text-[17px] text-center leading-[17px] tracking-[0.32px] font-inter-580-24 text-white',
            )}>
        ...
        <Animated.View style={tailwind.style('flex-1 items-end')}>
          <Pressable onPress={handleToggleState} hitSlop={16}>
            <Icon icon={<InboxFilterIcon stroke="white" />} size={24} />
          </Pressable>
        </Animated.View>
      </Animated.View>
      <BottomSheetModal
